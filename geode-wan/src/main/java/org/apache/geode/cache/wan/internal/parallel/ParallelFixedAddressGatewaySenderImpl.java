...
import org.apache.geode.cache.wan.internal.AbstractFixedAddressGatewaySender;
...
/**
 * Parallel GatewaySender implementation that connects to a fixed hostname:port
 * instead of discovering receivers through locators.
 *
 * @since Geode 1.16
 */
public class ParallelFixedAddressGatewaySenderImpl extends AbstractFixedAddressGatewaySender {

  private static final Logger logger = LogService.getLogger();

  public ParallelFixedAddressGatewaySenderImpl(InternalCache cache, StatisticsClock statisticsClock,
  ...
  public String toString() {
    return "ParallelFixedAddressGatewaySender{"
        + "id=" + getId()
        + ",remoteDsId=" + getRemoteDSId()
        + ",remoteReceiverHostname=" + getRemoteReceiverHostname()
        + ",remoteReceiverPort=" + getRemoteReceiverPort()
        + ",isRunning =" + isRunning()
        + "}";
  }
