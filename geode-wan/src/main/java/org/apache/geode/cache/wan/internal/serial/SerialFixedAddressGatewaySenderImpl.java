...
/**
 * Serial GatewaySender implementation that connects to a fixed hostname:port
 * instead of discovering receivers through locators.
 *
 * @since Geode 1.16
 */
public class SerialFixedAddressGatewaySenderImpl extends AbstractFixedAddressGatewaySender {

  private static final Logger logger = LogService.getLogger();

  public SerialFixedAddressGatewaySenderImpl(InternalCache cache, StatisticsClock statisticsClock,
  ...
  public String toString() {
    return "SerialFixedAddressGatewaySender{"
        + "id=" + getId()
